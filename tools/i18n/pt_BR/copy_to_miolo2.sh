...
DIR="academic basic finance institutional selectiveProcess accountancy controlCopies humanResources research protocol gnuteca sagu2 services miolo trade accountsPayable"
if [ $1 ]
then
        DIR=$1
fi
